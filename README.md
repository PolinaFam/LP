h1 Backend на Python и Frontend на Javascript
***
...
В проекте отображается содержимое диска C:/. При нажатии на папку произойдет переход в неё, при нажатии на файл - предложит скачать. Есть возможность создать и удалить пустые папки.
```
